...
//9.(Optional) Create a class called "Recipe" that has properties for name, ingredients, and
//instructions. Add a method called "cook" that logs a message to the console indicating
//that the recipe is being cooked.
...
class Recipe {
  ...
  cook() {
    console.log(`Cooking ${this.name} requires ${this.ingredients} by following ${this.instructions}.`);
  }
}

const spaghetti = new Recipe(
  "California Spaghetti Salad",
  ["Spaghetti", "Cherry tomatoes", "Salad Dressing", "Cucumber", "Bell pepper", "Red onion", "Olives"],
...
//10.(Optional) Create a class called "Employee" that has properties for name, job title, and 
//salary. Add a method called "calculateBonus" that calculates and returns the employee's 
//bonus based on their salary.
...
class Employee {
  ...
  calculateBonus() {
    return this.salary * 0.2; // Assume bonus is 20% of salary
    
  }
}

// Example usage:
const employee1 = new Employee("William", "Doctor", 120000);
const employee2 = new Employee("Victoria", "Enginner", 96000);
